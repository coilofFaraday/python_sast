...
func (nl *NoneLiteral) TokenLiteral() string { return bl.Token.Literal }
...
func (pe *PrefixExpression) TokenLiteral() string { return bl.Token.Literal }
...
func (ie *InfixExpression) TokenLiteral() string { return bl.Token.Literal }
...
func (ie *IfExpression) TokenLiteral() string { return bl.Token.Literal }
...
func (bs *BlockStatement) TokenLiteral() string { return bl.Token.Literal }
...
func (fl *FunctionLiteral) TokenLiteral() string { return bl.Token.Literal }
...
func (ce *CallExpression) TokenLiteral() string { return bl.Token.Literal }
...
func (cd *ClassDeclaration) TokenLiteral() string { return bl.Token.Literal }
